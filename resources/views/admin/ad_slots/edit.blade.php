...
@section('title') Edit Ad Slot @endsection

@section('content')
@component('components.breadcrumb')
@slot('li_1') Home @endslot
@slot('li_2') Ad Slots @endslot
@slot('title') Edit Ad Slot @endslot
@endcomponent
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="card-title mb-0">Edit Ad Slot</h4>
                ...
                <form method="POST" action="{{ route('admin.ad-slots.update', $adSlot) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $adSlot->name) }}" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code', $adSlot->code) }}" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('page') is-invalid @enderror" id="page" name="page" value="{{ old('page', $adSlot->page) }}" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                <option value="predefined" {{ old('type', $adSlot->type) == 'predefined' ? 'selected' : '' }}>Predefined</option>
                                <option value="dynamic" {{ old('type', $adSlot->type) == 'dynamic' ? 'selected' : '' }}>Dynamic</option>
                            </select>
                    ...
                    <!-- Dynamic Options -->
                    <div id="dynamic-options" style="{{ $adSlot->type == 'dynamic' ? '' : 'display: none;' }}">
                        <div class="card mb-3 bg-light">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('selector') is-invalid @enderror" id="selector" name="selector" value="{{ old('selector', $adSlot->selector) }}">
                                        <small class="form-text text-muted">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select @error('position') is-invalid @enderror" id="position" name="position">
                                            <option value="before" {{ old('position', $adSlot->position) == 'before' ? 'selected' : '' }}>Before element</option>
                                            <option value="after" {{ old('position', $adSlot->position) == 'after' ? 'selected' : '' }}>After element</option>
                                            <option value="prepend" {{ old('position', $adSlot->position) == 'prepend' ? 'selected' : '' }}>Inside (Beginning)</option>
                                            <option value="append" {{ old('position', $adSlot->position) == 'append' ? 'selected' : '' }}>Inside (End)</option>
                                        </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3">{{ old('description', $adSlot->description) }}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            @if($adSlot->image)
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $adSlot->image) }}" alt="Position Image" class="img-fluid border rounded" style="max-height: 200px;">
                                </div>
                            @endif
                            <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="image">
                            <small class="form-text text-muted">
                                Upload a new image to replace the current one. Leave blank to keep the current image.
                            </small>
                            @error('image')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-switch form-switch-md">
                                <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" {{ old('is_active', $adSlot->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="col-sm-9">
                            <div class="d-flex flex-wrap gap-2">
                                <button type="submit" class="btn btn-primary waves-effect waves-light">
                                    <i data-feather="save" class="icon-sm me-1"></i> Update Ad Slot
                                </button>
                                <a href="{{ route('admin.ad-slots.index') }}" class="btn btn-secondary waves-effect">
                                    Cancel
                                </a>
