...
@section('title') Edit Knowledge Article @endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Edit Knowledge Article</h4>
                    ...
                    <form action="{{ route('admin.knowledge.articles.update', $article) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center mt-2">
                                ...
                                <span>Created: {{ $article->created_at->format('Y-m-d H:i') }}</span>
                            </div>
                            @if($article->published_at)
                                <div class="d-flex align-items-center mt-2">
                                    <i data-feather="clock" class="me-2"></i>
                                    <span>Published: {{ $article->published_at->format('Y-m-d H:i') }}</span>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('knowledge.article', ['category' => $article->category->slug, 'article' => $article->slug]) }}" class="btn btn-info" target="_blank">View Article</a>
                        </div>
                    </form>
                </div>
            </div>
