                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                ...
                                <small class="form-text text-muted">
                                    Profile picture will be automatically fetched from <a href="https://gravatar.com" target="_blank">Gravatar</a> based on this email.
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-9 offset-md-3">
                                <button type="submit" class="btn btn-primary">
                                    <i data-feather="user-plus" class="icon-sm me-1"></i> Create User
                                </button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Preview Gravatar when email is entered
        ...
        if (email) {
            email.addEventListener('blur', function() {
                if (this.value) {
                    // Check if there is already a preview container
                    let previewContainer = document.getElementById('gravatar-preview');
                    
                    if (!previewContainer) {
                        previewContainer = document.createElement('div');
                        previewContainer.id = 'gravatar-preview';
                    ...
                    previewContainer.innerHTML = `
                        <div class="d-flex align-items-center">
                            <img src="${gravatarUrl}" class="rounded-circle me-3" width="80" height="80">
                            <div>
                                <p class="mb-1">Gravatar Preview for <strong>${nameField.value || 'New User'}</strong></p>
                                <small class="text-muted">This image is based on the provided email address</small>
                            </div>
                        </div>
                    `;
                }
